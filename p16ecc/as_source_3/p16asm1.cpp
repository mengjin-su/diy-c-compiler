		...
		switch ( lp->inst )
		{
			...
			default:	// all regular instructions ...
				...
				if ( p16inst )
				{
					...
					switch ( p16inst->form )
					{
						case P16_FD_I:		// ADDWF x, W  or  ADDWF x, F
						...
						case P16_LIT5_I:	// MOVLB	- enhanced PIC16F
						case P16_LIT6_I:	// MOVLB	- extended PIC16F
						...
						case P16_MOV_OP_I:	// MOVWI ++FSR0, MOVWI --FSR0, ...
							switch ( ip0->type )
							{
